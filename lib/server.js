...
app.get('/qr', (req, res) => {
    if (!global.__qrImage) {
        return res.status(404).send('QR code not available yet. Bot may already be connected.');
    }
    const html = `<!DOCTYPE html>
<html>
<head><title>MEGA-MD QR Code</title>
<meta name="viewport" content="width=device-width, initial-scale=1">
<style>
body{margin:0;padding:20px;background:#111;display:flex;justify-content:center;align-items:center;min-height:100vh;font-family:system-ui;color:#fff;text-align:center}
img{max-width:100%;border-radius:12px;box-shadow:0 0 30px rgba(37,211,102,0.3)}
h2{color:#25d366}
p{color:#aaa;margin:10px 0 0}
</style>
</head>
<body>
<div>
<h2>MEGA-MD QR Code</h2>
<img src="${global.__qrImage}" alt="QR Code">
